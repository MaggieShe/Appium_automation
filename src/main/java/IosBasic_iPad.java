...
////        WebElement pull_to_refresh = driver.findElement(By.name("Pull to refresh"));
//        TouchAction pull_down = new TouchAction(driver);
//        pull_down.press()
//                //moveTo(pull_to_refresh).release();
////        pull_down.tap(10, 50).perform();
//        takeScreenshot(driver);
//        Thread.sleep(2000);
